...
opt = TopoOpt(res=(n, n, n), version=version, volume_fraction=volume_fraction,
              ...
              fix_cells_at_dirichlet=False, fix_cells_near_force=True, connectivity_filtering=True, adaptive_min_fraction=False, verbose_snapshot=True)
...
# Set up BCs  (note: bc boundary condition)
