...
tex = tc.Texture(
    ...
    scale=(s, s, s),
    adaptive=False,
    filename='projects/spgrid/data/wing_2.obj')
...
opt.general_action(action='add_mesh_normal_force', mesh_fn='projects/spgrid/data/wing_2.obj', magnitude=-1, center=(0.21, 0.26, 0), falloff=3000, maximum_distance=0.005)
