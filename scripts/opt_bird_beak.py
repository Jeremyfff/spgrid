...
tex = tc.Texture(
  ...
  scale=(s, s, s),
  adaptive=False,
  filename='projects/spgrid/data/beak.obj')
...
# try plane force
opt.general_action(action='add_mesh_normal_force', mesh_fn='projects/spgrid/data/beak.obj', magnitude=-1, center=(0.5, 0, 0), falloff=1000, maximum_distance=0.015, override=(0, 0, 0))
